...
export function FactsDetails() {
	return (
		<div className="border-2 border-solid border-primary rounded-lg w-full h-full px-4 items-center py-10 gap-6 flex flex-col">
			<h1 className=" font-Inter font-bold text-primary-content text-5xl text-center">
				FcAs
			</h1>
			<ScrollArea
				...
				<Box
					...
					<Flex
						direction="column"
						gap="2">
						<div className="w-full text-base sm:text-xs md:text-base text-nowrap flex flex-row justify-between items-center py-2 font-Poppins font-semibold text-primary-content">
							<span>since of :</span>
