...
export function FactsDetails() {
	return (
		<div className="border-2 border-solid border-WHITE rounded-lg w-full h-full px-4 items-center py-10 gap-6 flex flex-col">
			...
			<ScrollArea
				className="border-t border-solid border-WHITE"
				type="auto"
				scrollbars="vertical"
				style={{ height: "90%" }}>
				<Box
					...
					<Flex
						direction="column"
						gap="2">
						<div className="w-full text-base sm:text-xs md:text-base text-nowrap flex flex-row justify-between items-center py-2 font-Poppins font-semibold text-WHITE">
							<span>since of :</span>
